...
| Path | Contents |
|---|---|
| `paper/` | Authoritative manuscript `tbv_mdr_GPTedit-03.tex`, bibliography `MDR_TBV_Paper01.bib`, and matching PDF `tbv_mdr_GPTedit-03.pdf` |
...
```bash
cd paper
latexmk -pdf tbv_mdr_GPTedit-03.tex
```
